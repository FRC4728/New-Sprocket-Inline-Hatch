...
public class BumpSideAuto extends SequentialCommandGroup {
  public double kP, kI, kD, kFF, kArbFF;

  public BumpSideAuto(Swerve s_Swerve, ArmSubsystem s_Arm, HandSubsystem s_Hand, ExtendingSubsystem s_Extend,
      HopperSubsystem s_Hopper, PistonSubsystem s_Piston, HashMap<String, Command> eventMap) {
    // Path Planner Path
    String robot_path = "Bump Side Test";
